...
namespace Forum.Data.Migrations
{
    ...
    [Migration("20210615100831_Like_Dislike")]
    partial class Like_Dislike
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TopicUser", b =>
                {
                    b.Property<int>("TopicsLikeId")
                        .HasColumnType("int");

                    b.Property<int>("UsersLikeId")
                        .HasColumnType("int");

                    b.HasKey("TopicsLikeId", "UsersLikeId");

                    b.HasIndex("UsersLikeId");

                    b.ToTable("TopicUserLike");
                });

            modelBuilder.Entity("TopicUser1", b =>
                {
                    b.Property<int>("TopicsDislikeId")
                        .HasColumnType("int");

                    b.Property<int>("UsersDislikeId")
                        .HasColumnType("int");

                    b.HasKey("TopicsDislikeId", "UsersDislikeId");

                    b.HasIndex("UsersDislikeId");

                    b.ToTable("TopicUserDislike");
                });
            ...
            modelBuilder.Entity("TopicUser1", b =>
                {
                    b.HasOne("Forum.Data.Entities.Topic", null)
                        .WithMany()
                        .HasForeignKey("TopicsDislikeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Forum.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UsersDislikeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
