...
{
    public class TopicToCreateViewModelValidatorTest
    {
        private readonly TopicToCreateViewModelValidator validator;

        public TopicToCreateViewModelValidatorTest() => validator = new TopicToCreateViewModelValidator();
